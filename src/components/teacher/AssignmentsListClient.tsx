...
import { Search, Calendar, ChevronRight, X, BookOpen, GraduationCap, Layers } from "lucide-react";
...
export function AssignmentsListClient({ initialAssignments }: AssignmentsListClientProps) {
    ...
    }, [initialAssignments, searchQuery, selectedClass, selectedSubject]);
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between px-2">
                <p className="text-sm font-bold text-slate-500 dark:text-slate-400">
                    Menampilkan <span className="text-primary">{filteredAssignments.length}</span> tugas
                </p>
            </div>

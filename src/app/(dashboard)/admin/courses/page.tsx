...
import { BookOpen, GraduationCap, User, List, PlusCircle } from "lucide-react";
...
export default async function AdminCoursesPage({
    ...
    searchParams: Promise<{ classId?: string; subjectId?: string; teacherId?: string; tab?: string }>
}) {
    const { classId, subjectId, teacherId, tab = 'list' } = await searchParams;
